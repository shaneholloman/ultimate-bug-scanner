...
print_category "Detects: weak hashes, math/rand for security, InsecureSkipVerify, shell exec, dynamic SQL strings, request path traversal, open redirects, outbound URL SSRF, unsafe archive extraction" \
