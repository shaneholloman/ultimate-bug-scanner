...
║                                                                      ║
BANNER
echo -e "║       ${BOLD}${GREEN}${GEM} RB BUG SCANNER${RESET}${BOLD}${CYAN} v1.0 ${BLUE}━━━━━━━━━━━━━━━━━━━━━━━━━━━━${CYAN}       ║"
cat << 'BANNER'
║                                                                      ║
║        🎯 Industrial-Grade Ruby 3.3+ Code Analysis (Bash)            ║
║   Powered by AST-Grep + Heuristics + Bundler-backed analyzers        ║
