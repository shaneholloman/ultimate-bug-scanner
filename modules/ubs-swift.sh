...
print_header "6. SECURITY"
 print_category "Detects: trust-all URLSession delegate, hardcoded secrets, request path traversal, request-derived open redirects, request-derived outbound URL/SSRF, insecure unarchiving, unsafe archive extraction, Process misuse" \
