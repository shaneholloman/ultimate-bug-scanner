...
| Clean files (`clean/*.rs`) | `Result` handling, JoinHandle waiting, integer cents, safe temp-file creation, safe redirect validation, safe response-header values, safe outbound URL validation, parameterized SQL, safe CORS origin allow-lists |
