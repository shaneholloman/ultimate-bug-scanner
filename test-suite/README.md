...
| Python | `test-suite/python/buggy/`, `test-suite/python/security/` | `test-suite/python/clean/`, `test-suite/python/security/` | Async/security/resource fixtures + mutable defaults, shell injection, archive traversal, open redirects, SSRF, path traversal, JWT verification, credentialed CORS, session cookie flags |
