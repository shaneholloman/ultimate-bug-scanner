...
|----------|------------|------------|------------|
| JavaScript/TypeScript | `test-suite/buggy/`, `test-suite/js/buggy/`, `test-suite/js/type_narrowing/` | `test-suite/clean/`, `test-suite/js/clean/`, `test-suite/js/type_narrowing/clean/` | 20 core files + framework + realistic + edge cases plus dedicated type-narrowing, credentialed CORS, cookie security, security randomness, disabled TLS verification, fetch-cancellation, JWT verification, and archive extraction fixtures |
