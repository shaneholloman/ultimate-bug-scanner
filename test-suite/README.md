...
| Go | `test-suite/golang/buggy/`, `test-suite/golang/security/` | `test-suite/golang/clean/`, `test-suite/golang/security/` | Concurrency, HTTP safety, context leaks, ticker/perf issues, request/header path traversal, request-derived outbound URL/SSRF, archive extraction |
| C/C++ | `test-suite/cpp/buggy/`, `test-suite/cpp/security/` | `test-suite/cpp/clean/`, `test-suite/cpp/security/` | RAII vs leaks, unsafe `strcpy`, request/header path traversal, archive extraction, overflow/memory hygiene |
...
| Ruby | `test-suite/ruby/buggy/`, `test-suite/ruby/path_traversal_buggy/`, `test-suite/ruby/archive_extraction_buggy/`, `test-suite/ruby/ssrf_buggy/` | `test-suite/ruby/clean/`, `test-suite/ruby/path_traversal_clean/`, `test-suite/ruby/archive_extraction_clean/`, `test-suite/ruby/ssrf_clean/` | eval/YAML problems, thread leaks, file cleanup, request/header path traversal, request-derived outbound URL/SSRF, archive extraction |
...
| Elixir | `test-suite/elixir/buggy/` | `test-suite/elixir/clean/` | Shell-backed command execution, request/header path traversal, request-derived outbound URL/SSRF, archive extraction |
