...
- The canonical Rust/TypeScript/Go SARIF evidence in `test-suite/goldens/ast_grep_rule_pack_sarif.json` still matches the emitted rule IDs, result counts, driver rule list shape, and per-rule ast-grep YAML inventory.
