...
| Go | `test-suite/golang/buggy/`, `test-suite/golang/security/` | `test-suite/golang/clean/`, `test-suite/golang/security/` | Concurrency, HTTP safety, context leaks, ticker/perf issues, request path traversal, archive extraction |
