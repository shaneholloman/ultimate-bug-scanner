...
| Go | `test-suite/golang/buggy/`, `test-suite/golang/security/` | `test-suite/golang/clean/`, `test-suite/golang/security/` | Concurrency, HTTP safety, context leaks, ticker/perf issues, request/header path traversal, request-derived open redirects, request-derived outbound URL/SSRF, archive extraction |
| C/C++ | `test-suite/cpp/buggy/`, `test-suite/cpp/security/` | `test-suite/cpp/clean/`, `test-suite/cpp/security/` | RAII vs leaks, unsafe `strcpy`, request/header path traversal, request-derived outbound URL/SSRF, archive extraction, overflow/memory hygiene |
| Rust | `test-suite/rust/buggy/` | `test-suite/rust/clean/` | `unwrap()` panics, async tasks, command injection, request-derived outbound URL/SSRF, archive extraction, predictable temp-file writes, float precision, type-narrowing demo |
| Java | `test-suite/java/buggy/`, `test-suite/java/security/` | `test-suite/java/clean/`, `test-suite/java/security/` | Executor leaks, blocking I/O, SQL/command injection, request/header path traversal, request-derived open redirects, request-derived outbound URL/SSRF, archive extraction |
| Kotlin (Java-family scanner) | `test-suite/kotlin/security_buggy/`, `test-suite/kotlin/path_traversal_buggy/`, `test-suite/kotlin/open_redirect_buggy/`, `test-suite/kotlin/ssrf_buggy/`, `test-suite/kotlin/archive_extraction_buggy/`, `test-suite/kotlin/type_narrowing/buggy/` | `test-suite/kotlin/security_clean/`, `test-suite/kotlin/path_traversal_clean/`, `test-suite/kotlin/open_redirect_clean/`, `test-suite/kotlin/ssrf_clean/`, `test-suite/kotlin/archive_extraction_clean/`, `test-suite/kotlin/type_narrowing/clean/` | ProcessBuilder shell injection, request/header path traversal, request-derived open redirects, request-derived outbound URL/SSRF, archive extraction path traversal, nullable guard fallthrough |
