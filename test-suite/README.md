...
| Java | `test-suite/java/buggy/`, `test-suite/java/security/` | `test-suite/java/clean/`, `test-suite/java/security/` | Executor leaks, blocking I/O, SQL/command injection, request/header path traversal, request-derived outbound URL/SSRF, archive extraction |
| Kotlin (Java-family scanner) | `test-suite/kotlin/security_buggy/`, `test-suite/kotlin/path_traversal_buggy/`, `test-suite/kotlin/ssrf_buggy/`, `test-suite/kotlin/archive_extraction_buggy/`, `test-suite/kotlin/type_narrowing/buggy/` | `test-suite/kotlin/security_clean/`, `test-suite/kotlin/path_traversal_clean/`, `test-suite/kotlin/ssrf_clean/`, `test-suite/kotlin/archive_extraction_clean/`, `test-suite/kotlin/type_narrowing/clean/` | ProcessBuilder shell injection, request/header path traversal, request-derived outbound URL/SSRF, archive extraction path traversal, nullable guard fallthrough |
