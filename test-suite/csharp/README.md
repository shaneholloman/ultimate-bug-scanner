...
- `security/RequestPathTraversalBuggy.cs` and `security/RequestPathTraversalClean.cs` cover ASP.NET request/upload values flowing into file read/write/serve/delete sinks.
- `security/SsrfBuggy.cs` and `security/SsrfClean.cs` cover ASP.NET request values flowing into outbound HTTP clients.
